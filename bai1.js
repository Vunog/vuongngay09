function validateForm() {
    ...
    var reigon = document.getElementById("reigon").value;

    if (!name || !email || !sex || !dob || !address || !city || !zip || !reigon) {
...
function clearForm() {
    ...
    document.getAnimations("address").value ="";
    document.getElementById("city").value = "";
    document.getAnimations("zip").value = "";
    document.getElementById("zip").value = "";
    document.getElementById("reigon").value = "";
}